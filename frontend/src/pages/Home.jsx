            ...
            <div className="div-2">
                ...
                <div className="home-section overlap-9">
                    <div className="baner">
                        ...
                        <div className="baner-content">
                            ...
                            {loaded && <FindNannyButton role={userType} id={id} className="find-nanny-button-class" />}
                        </div>
                ...
                <div className="home-section about-section">
                    <div className="about-content">
                        ...
                        <div id="about" className="about-text-home">
                ...
                <div className="home-section">
                    ...
                    <div className="typecard-wrapper">
                        <TypeCard className="type-card-instance" imgSrc="/assets/ILLUSTRATION-03.svg" />
                        <TypeCard className="type-card-2" text="НЯНЯ СУПРОВІД ЗА КОРДОН" text1={<>Допомога та підтримка дитини <br /> під час подорожі.</>} imgSrc="/assets/ILLUSTRATION-02.svg" />
                        <TypeCard className="type-card-3" text="НЯНЯ З ПРОЖИВАННЯМ" text1="Щоденний догляд, розвиток, супровід дитини у комфортній атмосфері." imgSrc="/assets/ILLUSTRATION-04.svg" />
                        <TypeCard className="type-card-2" text="НЯНЯ ПОГОДИННО" text1="Приходить за потреби на декілька годин, коли батькам потрібно." imgSrc="/assets/ILLUSTRATION-08.svg" />
                        <TypeCard className="type-card-5" text="НЯНЯ З ПРОФЕСІЙНОЮ ОСВІТОЮ" text1={<>Догляд, розвиток і підтримка дітей <br /> з особливими потребами.</>} imgSrc="/assets/ILLUSTRATION-06.svg" />
                        <TypeCard className="type-card-2" text="НЯНЯ-ДОМОГОСПОДАРКА" text1="Поєднує догляд за дитиною з допомогою по дому." imgSrc="/assets/ILLUSTRATION-07.svg" />
                    </div>
                ...
                <div id="reviews" className="home-section reviews-section-home">
                    ...
                    <div className="review-overlay-container">
                        ...
                        <div className="msgcard-wrapper position-6">
                            <MsgCard property1="default" />
                        </div>
